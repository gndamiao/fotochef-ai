      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl p-8 border border-destructive/20" style={{ background: "hsl(0, 30%, 4%)" }}>
            ...
            <h3 className="font-playfair text-xl font-bold mb-6 text-destructive">Sem FotoChef</h3>
          ...
          <div className="rounded-xl p-8 border border-green-600/20" style={{ background: "hsl(120, 30%, 4%)" }}>
            <div className="text-4xl mb-4">✅</div>
            <h3 className="font-playfair text-xl font-bold mb-6 text-green-500">Com FotoChef</h3>
            <ul className="space-y-3">
              {comItems.map((item) => (
